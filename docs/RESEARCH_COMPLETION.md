...
**Documentation aligned August 2026:** [OBJECTIVES_EVIDENCE.md](OBJECTIVES_EVIDENCE.md) now lists **3 algorithms** and the final hybrid operating configuration **α=0.5, β=0.5, Warning=15, Dangerous=50** (matches production code).
