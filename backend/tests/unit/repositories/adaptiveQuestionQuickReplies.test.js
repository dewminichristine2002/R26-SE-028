const { normalizeQuickReplies } = require('../../../src/repositories/adaptiveQuestionBankRepository');
const { mapQuestionForResponse } = require('../../../src/controllers/adaptiveChatController');
