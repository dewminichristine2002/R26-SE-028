jest.mock('../../repositories/reminiscenceMemoryEntryRepository');
const entryRepo = require('../../repositories/reminiscenceMemoryEntryRepository');
...
describe('reminiscence entries controller (create/list/delete)', () => {
  test('createEntry returns 400 for invalid user', async () => {
    const { createEntry } = require('../reminiscenceMemoryController');
